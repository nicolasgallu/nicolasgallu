...
As Data Engineer had the opportunity to work
in different moments of the data lifecycle, 
and having expertise in the following tools:
- Cloud Enviroments: GCP & AWS
- Orchestations Tools: Kubernetes, Airflow.
